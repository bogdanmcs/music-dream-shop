...
if(count($_POST)>0) {
    mysqli_query($con,"UPDATE basses set id='" . $_POST['id'] . "', btype='" . $_POST['btype'] . "', brand='" . $_POST['brand'] . "', model='" . $_POST['model'] . "' , 
    price='" . $_POST['price'] . "' , image='" . $_POST['image'] . "' WHERE id='" . $_POST['id'] . "'");
    header("location:bassesdb.php");
}
$result = mysqli_query($con,"SELECT * FROM basses WHERE id='" . $_GET['id'] . "'");
    ...
    <div class="row">
        ...
        <div class="col-md-4" style="background-color: navajowhite; border: 3px solid brown; border-radius: 20px; margin-top: 2%; margin-bottom: 2%">
            <form method="post" action="updateb.php">
                ...
                <input type="text" required="required" name="btype" style="border: 1px solid black; box-shadow: 3px 5px 6px black;margin-top: 1%" value="<?php echo $row['btype']; ?>">
                <br> <br>
