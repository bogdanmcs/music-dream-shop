...
if(count($_POST)>0) {
    mysqli_query($con,"UPDATE picks set id='" . $_POST['id'] . "', ptype='" . $_POST['ptype'] . "', 
    price='" . $_POST['price'] . "' , image='" . $_POST['image'] . "' WHERE id='" . $_POST['id'] . "'");
    header("location:picksdb.php");
}
$result = mysqli_query($con,"SELECT * FROM picks WHERE id='" . $_GET['id'] . "'");
    ...
    <div class="row">
        ...
        <div class="col-md-4" style="background-color: navajowhite; border: 3px solid brown; border-radius: 20px; margin-top: 2%; margin-bottom: 2%">
            <form method="post" action="updatep.php">
                ...
                <input type="text" required="required" name="ptype" style="border: 1px solid black; box-shadow: 3px 5px 6px black;margin-top: 1%" value="<?php echo $row['ptype']; ?>">
                <br> <br>
